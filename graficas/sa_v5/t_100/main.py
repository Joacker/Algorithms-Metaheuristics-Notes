...
archivos_csv = ['average_time_and_boxes.csv', 'average_time_and_boxes_seed_2.csv', 'average_time_and_boxes_seed_3.csv', 
                'average_time_and_boxes_seed_4.csv', 'average_time_and_boxes_seed_5.csv']
