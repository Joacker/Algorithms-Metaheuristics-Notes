...
archivos_csv = ['average_time_and_boxes_seed_1_25.csv', 'average_time_and_boxes_seed_2_25.csv', 'average_time_and_boxes_seed_3_25.csv', 
                'average_time_and_boxes_seed_4_25.csv', 'average_time_and_boxes_seed_5_25.csv']
