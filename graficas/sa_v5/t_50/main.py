...
archivos_csv = ['average_time_and_boxes_seed_1_50.csv', 'average_time_and_boxes_seed_2_50.csv', 'average_time_and_boxes_seed_3_50.csv', 
                'average_time_and_boxes_seed_3_50.csv', 'average_time_and_boxes_seed_5_50.csv']
